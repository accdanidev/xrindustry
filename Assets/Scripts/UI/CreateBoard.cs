...
public class CreateBoard : MonoBehaviour
{
    ...
    void Update()
    {
        if (openAI.responseBoard != "" && sended)
        {
            ...
            sended = false;
            this.gameObject.transform.parent.transform.parent.transform.parent.transform.parent.gameObject.SetActive(false);
